...
namespace TinyPG
{
    ...
    public class TextHighlighter : IDisposable
    {
        ...
        private void HighlightToken(Token token, StringBuilder sb)
        {
            switch (token.Type)
            {
                    case TokenType.PR_SETS:
                        sb.Append(@"{{\cf1 ");
                        break;
                    case TokenType.PR_TOKENS:
                        sb.Append(@"{{\cf2 ");
                        break;
                    case TokenType.PR_TOKEN:
                        sb.Append(@"{{\cf3 ");
                        break;
                    case TokenType.PR_ACCIONES:
                        sb.Append(@"{{\cf4 ");
                        break;
                    case TokenType.PR_RESERVADAS:
                        sb.Append(@"{{\cf5 ");
                        break;
